...
public class CommentActivityTip extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_comment_reply_edit_tips);
		...
		btnAdd.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (!etName.equals("") && !etNum.equals("")) {
					dbHandler.addTip(etName.getText().toString(), etNum
							.getText().toString());
